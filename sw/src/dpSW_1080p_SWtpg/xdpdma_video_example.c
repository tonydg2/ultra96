...
#define HTotal              1920    //1920, 1280
#define VTotal              1080     //1080, 720

#define BUFFERSIZE			HTotal * VTotal * 4		/* HTotal * VTotal * BPP */
#define LINESIZE			HTotal * 4			    /* HTotal * BPP */
...
void InitRunConfig(Run_Config *RunCfgPtr)
{
	/* Initial configuration parameters. */
		...
		RunCfgPtr->VideoMode = XVIDC_VM_1920x1080_60_P;//XVIDC_VM_1280x720_60_P;//XVIDC_VM_1920x1080_60_P;
...
int InitDpDmaSubsystem(Run_Config *RunCfgPtr)
{
	 ...
	 */
	XAVBuf_InputVideoSelect(AVBufPtr, XAVBUF_VIDSTREAM1_TPG,XAVBUF_VIDSTREAM2_NONE);//XAVBUF_VIDSTREAM1_TPG, //XAVBUF_VIDSTREAM1_LIVE
