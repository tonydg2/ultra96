...
#define BD_REG32_3_ADDR 0xa0020000
...
int main()
{
    ...
    while (1) {
      ...
      } else if (Ch == 'e') {   Xil_Out32(BD_REG32_2_ADDR + 0x18, 0x3);
      } else if (Ch == 'f') {   Xil_Out32(BD_REG32_2_ADDR + 0x1C, 0x4);
      } else if (Ch == 'g') {   Xil_Out32(BD_REG32_3_ADDR + 0x18, 0x5);
      } else if (Ch == 'h') {   Xil_Out32(BD_REG32_3_ADDR + 0x1C, 0x6);
      } else if (Ch == 'i') {
      } else if (Ch == 'j') {
      } else if (Ch == 'k') {
      } else if (Ch == 'l') {
      ...
      } else if (Ch == '0') {Xil_Out32(BD_REG32_2_ADDR + 0x18, 0x3);
      } else if (Ch == '1') {Xil_Out32(BD_REG32_2_ADDR + 0x1C, 0x4);
      } else if (Ch == '2') {Xil_Out32(BD_REG32_3_ADDR + 0x18, 0x5);
      } else if (Ch == '3') {Xil_Out32(BD_REG32_3_ADDR + 0x1C, 0x6);
